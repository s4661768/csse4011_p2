...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_THINGY52, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF52_ANOMALY_109_WORKAROUND, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF52_ANOMALY_109_WORKAROUND_EGU_INSTANCE, 5);
